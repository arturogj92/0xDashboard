            ...
            <div className="p-4 sm:p-6 space-y-6 w-full max-w-2xl mx-auto">
              ...
              {(instagramCaption || youtubeCaption || noVoice) && (
                <div ref={resultsRef} className="space-y-6">
                  {noVoice && (
                    <div className="bg-amber-950/50 p-6 rounded-lg border-2 border-amber-700/60 shadow-lg text-center">
                      <div className="flex items-center justify-center gap-2 mb-3">
                        <svg className="w-6 h-6 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path>
                        </svg>
                        <span className="text-amber-400 font-semibold text-lg">Notice</span>
                      </div>
