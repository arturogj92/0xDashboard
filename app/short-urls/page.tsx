          ...
          <div className="w-full max-w-4xl relative z-10 mb-8">
            ...
            <div className="flex items-start justify-between md:justify-center gap-1 sm:gap-2 md:gap-6 mb-6 w-full px-1">
              ...
              <div className="flex flex-col items-center w-1/4">
                <div className="bg-[#1c1033] rounded-xl w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 p-1 sm:p-2 md:p-3 relative">
                  <img src="/images/icons/url-shortener-create.png" alt="Create" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="flex flex-col items-center w-1/4">
                <div className="bg-[#1c1033] rounded-xl w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 p-1 sm:p-2 md:p-3 relative">
                  <img src="/images/icons/url-shortener-share.png" alt="Share" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="flex flex-col items-center w-1/4">
                <div className="bg-[#1c1033] rounded-xl w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 p-1 sm:p-2 md:p-3 relative">
                  <img src="/images/icons/url-shortener-track.png" alt="Track" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="flex flex-col items-center w-1/4">
                <div className="bg-[#1c1033] rounded-xl w-16 h-16 sm:w-20 sm:h-20 md:w-28 md:h-28 p-1 sm:p-2 md:p-3 relative">
                  <img src="/images/icons/url-shortener-stats.png" alt="Stats" className="w-full h-full object-contain" />
                </div>
