                ...
                <div className="px-6 pb-6">
                    ...
                    {keywords.length > 0 ? (
                        <div className="space-y-2 mb-6">
                            {keywords.map((keyword) => (
                                <div key={keyword.id} className="flex items-center justify-between bg-[#1f2937] px-4 py-3 rounded-md">
                    ...
                    <form onSubmit={handleAddKeyword} className="flex">
                        <input
                            ...
                            className="flex-1 bg-[#1f2937] text-white rounded-l-md border-0 px-4 py-2 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                        />
                        <button
                            type="submit"
                            disabled={loading}
